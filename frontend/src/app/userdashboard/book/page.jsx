      ...
      <div className="min-h-screen flex items-center justify-center p-6" style={{ background: "#1A1A1A" }}>
        ...
        <div className="book-font text-center anim-up" style={{ maxWidth: 400 }}>
          ...
          <p style={{ color: "#CCCCCC", fontSize: 15, lineHeight: 1.6 }}>
            Your request with <strong style={{ color: "#FFFFFF" }}>{businessName}</strong> has been sent.<br />
  ...
  return (
    <>
      <style>{`
        ...
        .book-wrap { font-family: 'DM Sans', sans-serif; min-height: 100vh; background: #1A1A1A; padding-top: 80px; margin: 0; }
        .book-serif { font-family: 'DM Serif Display', serif; }
        ...
        /* ── vendor card ── */
        .bk-vendor { background: #2C2C2C; border-radius: 20px; overflow: hidden; box-shadow: 0 1px 3px rgba(0,0,0,.4), 0 4px 20px rgba(0,0,0,.3); margin-bottom: 28px; border: 1px solid #3a3a3a; }
        ...
        .bk-date-input { width: 100%; border: 1.5px solid #3a3a3a; border-radius: 12px; padding: 13px 16px; font-size: 15px; font-family: inherit; color: #FFFFFF; background: #EAF0FB; transition: border .15s, box-shadow .15s; outline: none; color-scheme: light; }
        .bk-date-input:focus { border-color: #C0392B; box-shadow: 0 0 0 3px rgba(192,57,43,.2); background: #EAF0FB; }
        ...
        .bk-slot { border: 1.5px solid #3a3a3a; background: #252525; border-radius: 10px; padding: 10px 6px; font-size: 12px; font-weight: 500; color: #CCCCCC; cursor: pointer; transition: all .15s; text-align: center; outline: none; font-family: inherit; }
        ...
        .bk-textarea:focus { border-color: #C0392B; box-shadow: 0 0 0 3px rgba(192,57,43,.2); background: #EAF0FB; }
        ...
        .bk-btn-primary { flex: 2; padding: 14px; border: none; border-radius: 12px; font-size: 14px; font-weight: 600; color: #fff; background: #C0392B; cursor: pointer; font-family: inherit; transition: all .15s; display: flex; align-items: center; justify-content: center; gap: 8px; box-shadow: 0 4px 14px rgba(192,57,43,.4); }
      ...
      <div className="book-wrap">
        <div className="bk-inner">
          ...
          <div className="bk-progress">
            ...
            <span style={{ fontSize: 12, color: "#6b7280", marginLeft: 4 }}>Step {step} of 3</span>
          </div>
          ...
          {step === 3 && (
            <div className="anim-up">
              ...
              <div className="bk-summary">
                <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: ".1em", textTransform: "uppercase", color: "#6b7280", marginBottom: 4 }}>Booking Summary</div>
                ...
                {pricing && (
                  <div className="bk-summary-row">
                    ...
                    <span className="bk-summary-val" style={{ color: "#e74c3c" }}>₹{pricing}</span>
                  </div>
                )}
              </div>
