...
const ADDITIONAL = ALL_SERVICES.slice(6);
  ...
  return (
    ...
    <div className="min-h-screen" style={{ backgroundColor: "#111111" }}>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px" style={{ backgroundColor: "#2a2a2a", border: "1px solid #2a2a2a" }}>
